...
export interface Settings {
  theme: "dark" | "light" | "forest" | "ocean" | "sunset" | "lavender";
  ...
  subjectSortOrder: "name" | "hours" | "recent" | "manual";
}
...
export function useSettings() {
  ...
  const mergedSettings: Settings = {
    ...
    hiddenSubjects: settings.hiddenSubjects ?? [],
    pinnedSubjects: settings.pinnedSubjects ?? [],
    subjectSortOrder: settings.subjectSortOrder ?? "recent",
    theme: ["dark", "light", "forest", "ocean", "sunset", "lavender"].includes(settings.theme as any) 
