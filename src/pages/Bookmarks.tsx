...
export default function Bookmarks() {
  ...
  const addBookmark = () => {
    if (!name.trim()) {
      toast.error("Name required", { description: "Please enter a bookmark name" });
      return;
    }

    if (!url.trim()) {
      toast.error("URL required", { description: "Please enter a URL" });
      return;
    }
    ...
    toast("Bookmark added", { description: "Your bookmark has been created" });
  };
  ...
  const updateBookmark = () => {
    ...
    toast("Bookmark updated", { description: "Your bookmark has been updated" });
  };
  ...
  const deleteBookmark = (id: string) => {
    ...
    toast("Bookmark deleted", { description: "The bookmark has been removed" });
  };
